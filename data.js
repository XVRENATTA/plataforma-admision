...
const questionBank = {
  matematicas: [
    ...
    },
    {
      ...
      question: "Resuelve la siguiente resta de fracciones: 3/4 - 1/2",
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Semejantes", "Equiláteros", "Congruentes", "Isósceles"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["El término cuadrático", "El término lineal", "La raíz de la ecuación", "El término independiente"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["16 y -16", "4 y -4", "Solamente 4", "Solamente 16"],
  ...
  fisica: [
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Extensiva", "Química", "General", "Intensiva"],
    ...
    },
    {
      ...
      difficulty: "dificil",
      options: ["Una curva parabólica", "Una línea horizontal paralela al tiempo", "Una recta inclinada", "Un círculo"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["7.8 x 10^5", "78 x 10^-6", "7.8 x 10^-5", "0.78 x 10^-4"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Solo su unidad de medida", "Solo su valor numérico", "Dirección y sentido", "El instrumento de medición"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["K = °C - 273.15", "K = (°C * 1.8) + 32", "K = °C + 273.15", "K = °C / 273.15"],
    ...
    },
    {
      ...
      difficulty: "dificil",
      options: ["v = m*d", "v = d/m", "v = m/d", "v = m-d"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["m = P*g", "m = P/g", "m = g/P", "m = P+g"],
  ...
  quimica: [
    {
      ...
      difficulty: "dificil",
      options: ["Hidróxido (OH-)", "Sodio (Na+)", "Hidrógeno (H+)", "Cloruro (Cl-)"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Porcentaje de plomo molecular", "Partes de soluto por cada millón de partes de disolución", "Peso por medida", "Partículas por mol"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Filtración", "Decantación", "Cromatografía", "Centrifugación"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Enlace metálico", "Enlace covalente polar", "Enlace covalente no polar", "Enlace iónico"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Electrones en la última capa", "Neutrones en el núcleo", "Masa total del átomo", "Protones en el núcleo"],
    ...
    },
    {
      ...
      difficulty: "medio",
      options: ["Cumplir la ley de los gases ideales", "Cumplir la ley de la conservación de la materia", "Saber cuánta energía se libera", "Determinar si la reacción es rápida o lenta"],
    ...
    },
    {
      ...
      difficulty: "dificil",
      options: ["2, 2, 2", "1, 3, 2", "1, 2, 3", "3, 1, 2"],
